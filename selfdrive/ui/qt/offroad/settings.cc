...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
    ...
    cruiseToggles->addItem(new CValueControl("CruiseButtonMode", "Button: Cruise Speed Mode", "0:Normal,1:User1,2:User2", "../assets/offroad/icon_road.png", 0, 2, 1));
    ...
    speedToggles->addItem(new CValueControl("AutoTurnControlSpeedLaneChange", "NOO Helper LaneChange Speed (60)", "0:없음,차로변경속도", "../assets/offroad/icon_road.png", 0, 100, 10));
    ...
    speedToggles->addItem(new CValueControl("AutoTurnControlTurnEnd", "NOO Helper Turn CtrlDistTime (3)", "속도*거리", "../assets/offroad/icon_road.png", 0, 30, 1));
