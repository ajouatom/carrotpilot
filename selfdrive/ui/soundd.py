...
sound_list: Dict[int, Tuple[str, Optional[int], float]] = {
  ...
  AudibleAlert.engage: ("engage.wav", 1, float(self.params.get_int("SoundVolumeAdjustEngage"))/100.),
  AudibleAlert.disengage: ("disengage.wav", 1, float(self.params.get_int("SoundVolumeAdjustEngage"))/100.),
